...
# Block class to represent game objects
...
# Player class, inherits from Block
class Player(Block):
...
# Ball class, inherits from Block
class Ball(Block):
    ...
    def collisions(self):
        # Handle collisions with screen boundaries and paddles
    ...
    def reset_ball(self):
        # Reset ball position and prepare for the next round
        self.active = False
    ...
    def restart_counter(self):
        # Handle countdown before restarting the ball
...
# Opponent class, inherits from Block
class Opponent(Block):
    ...
    def update(self, ball_group):
        # Update opponent position based on ball position
    ...
    def constrain(self):
        # Constrain opponent within screen boundaries
        if self.rect.top <= 0:
            self.rect.top = 0
        if self.rect.bottom >= screen_height:
            self.rect.bottom = screen_height

# GameManager class to manage game state
class GameManager:
    ...
    def run_game(self):
        # Drawing and updating game objects
    ...
    def draw_score(self):
        # Draw player and opponent scores on the screen
